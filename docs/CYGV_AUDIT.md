...
polygon-5 `[4,3,2]` `N=4` check to complete. Iterating only sparse valid product
pairs improves that narrowed run to about 149 seconds, but the sample still
spends almost all time in inverse mirror-map composition and rational polynomial
