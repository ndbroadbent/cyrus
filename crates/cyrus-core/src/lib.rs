...
pub use gv::{
    ...
    NilpotentRayDegreeSlice, NilpotentRaySliceComparisonPoint, OneDimensionalRayGvSeries,
    ...
    nilpotent_ray_degree_slice_for_cutoff_fraction, nilpotent_ray_slice_comparison_points,
