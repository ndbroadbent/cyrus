...
pub use gv::{
    ...
    CurveDecompositionTerm, CurvePruningStrategy, LocalToricCircuitKind, LocalToricCoordinate2D,
    ...
    find_pair_decomposition, find_semigroup_decomposition, identify_ckyz_local_surface,
    map_basis_gv_invariants_to_ambient, potent_ray_convergence, potent_ray_log_xi_slope,
    potent_ray_log_xi_terms, project_ambient_curve_to_basis, project_ambient_curve_to_basis_matrix,
