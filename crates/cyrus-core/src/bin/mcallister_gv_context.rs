...
struct ContextReport {
    ...
    origin_circuit_witness_relation_span_closure_status_counts: BTreeMap<String, usize>,
    origin_circuit_witness_shared_facet_span_closure_status_counts: BTreeMap<String, usize>,
    origin_circuit_witness_facet_union_span_closure_status_counts: BTreeMap<String, usize>,
...
struct LocalCygvSourceResolutionHintSummary {
    ...
    shared_two_simplex_star_target_relation_status: String,
    shared_two_simplex_star_target_relation_missing_points: Vec<usize>,
    shared_two_simplex_star_target_relation_extra_star_points: Vec<usize>,
    shared_two_simplex_star_target_relation_coordinates: Option<Vec<i64>>,
...
struct CygvPathHistoryProbe {
    ...
    path_support_target_gv_coefficient_status: Option<String>,
    path_support_target_instanton_coefficient: Option<String>,
    path_support_target_gv_candidate: Option<String>,
...
#[derive(Clone, Debug, Serialize)]
struct CygvPathSupportQnTracePolynomialSample {
    element_index: usize,
    degree: u32,
    curve_nonzero: Vec<(usize, i64)>,
    term_count: usize,
    term_sample_limit: usize,
    term_sample: Vec<CygvPathSupportQnTraceTermSample>,
}

#[derive(Clone, Debug, Serialize)]
struct CygvPathSupportQnTraceTermSample {
...
struct CygvResidualQnDomainTermClassification {
    ...
    parent_path_support_rounded_gv_candidate: Option<String>,
...
struct PathSupportCurveRuntimeLookup {
    path_support_gv: Option<String>,
    ...
    path_support_rounded_gv_candidate: Option<String>,
}
...
struct PathSupportGeneratorProbe {
    ...
    target_qn_trace_status: Option<String>,
    target_qn_trace_term_count: Option<usize>,
    target_gv_coefficient_status: Option<String>,
    target_instanton_coefficient: Option<String>,
    target_gv_candidate: Option<String>,
...
fn path_support_qn_trace_sample(
    qn_trace: &[CygvQnTracePolynomial],
) -> Vec<CygvPathSupportQnTracePolynomialSample> {
    qn_trace
        .iter()
        .take(CYGV_PATH_SUPPORT_QN_TRACE_SAMPLE_LIMIT)
        .map(|poly| CygvPathSupportQnTracePolynomialSample {
            ...
            term_sample: poly
                ...
                .iter()
                .take(CYGV_PATH_SUPPORT_QN_TRACE_TERM_SAMPLE_LIMIT)
                .map(|term| CygvPathSupportQnTraceTermSample {
...
fn build_report(
    ...
    let origin_circuit_witness_relation_span_closure_status_counts =
        origin_circuit_witness_domain_status_counts(
            &origin_circuit_witness_domain_sample,
            |summary| &summary.relation_span_closure_probe.status,
        );
    let origin_circuit_witness_shared_facet_span_closure_status_counts =
        origin_circuit_witness_domain_status_counts(
            &origin_circuit_witness_domain_sample,
            |summary| &summary.shared_facet_span_closure_probe.status,
        );
    let origin_circuit_witness_facet_union_span_closure_status_counts =
        origin_circuit_witness_domain_status_counts(
            &origin_circuit_witness_domain_sample,
            |summary| &summary.facet_union_span_closure_probe.status,
        );
    ...
    let cygv_closest_known_qn_residual_qn_domain_parent_only_parent_path_support_qn_trace_status_counts =
        cygv_closest_known_qn_residual_qn_domain_parent_only_parent_path_support_qn_trace_status_counts(
            &targets,
        );
    ...
    let cygv_closest_known_qn_residual_qn_domain_parent_only_bounded_seed_diamond_error_counts =
        cygv_closest_known_qn_residual_qn_domain_parent_only_bounded_seed_diamond_error_counts(
            &targets,
        );
    ...
    let unit_probes_by_target = local_cygv_target_unit_phase_probe_sample
        .iter()
        .cloned()
        .map(|probe| (probe.target_index, probe))
        .collect::<HashMap<_, _>>();
    for target in &mut targets {
        target.local_cygv_unit_phase_probe = unit_probes_by_target.get(&target.index).cloned();
    }
    ...
    ContextReport {
        ...
        origin_circuit_witness_relation_span_closure_status_counts,
        origin_circuit_witness_shared_facet_span_closure_status_counts,
        origin_circuit_witness_facet_union_span_closure_status_counts,
...
mod tests {
    ...
    fn origin_circuit_ambient_generator_counts_filter_source_supports() {
        ...
        assert_eq!(
            summaries[0].relation_span_closure_probe.status,
            "span_closed_under_degree_bounded_context"
        );
        assert_eq!(
            summaries[0].shared_facet_span_closure_probe.status,
            "span_closure_has_extra_generators"
        );
        assert_eq!(
            summaries[0]
                .shared_facet_span_closure_probe
                .extra_generator_count,
            Some(1)
        );
        assert_eq!(
            summaries[0].shared_facet_span_closure_probe.extra_sample[0].basis_nonzero,
            vec![(0, 1), (1, 1)]
        );
        let skipped_span_probe = origin_circuit_witness_domain_span_closure_probe(
            &[vec![1, 0]],
            &context,
            sample.degree,
            Some(2),
        ...
        assert_eq!(
            skipped_span_probe.status,
            "span_closure_skipped_scan_limit_2_actual_3"
        );
    ...
    fn weighted_p2_resolution_hint_records_zero_relation_shared_ray() {
        ...
        let star_union_hint =
            local_cygv_star_union_relation_hint(Some(&witness), &star_support_hint);
        assert_eq!(
