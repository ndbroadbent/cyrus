...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "generic no-assertion runs default K/M flux vectors to Cyrus' computed dual basis instead of the McAllister [3,4,5,8] source basis; --dual-basis now accepts index or matrix validation-source flux coordinate bases",
