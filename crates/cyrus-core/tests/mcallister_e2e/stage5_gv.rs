...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_gv_context now accepts schema-4 corrected-chamber GV context exports and aggregates closest known q_N residual statuses and degree splits; a bounded target-7 report on 4-214-647 records the residual split as a known source-derived degree-6 predecessor plus a known toric degree-2 difference",
