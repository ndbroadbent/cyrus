...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_gv_context now promotes unknown sides of lower-seed predecessor candidates into a unique diagnostic queue; target-7/8 schema-4 smokes record degree-4 and degree-8 composite rows, all classified as not_source_degree_bounded_ray rather than uncovered source leaves",
