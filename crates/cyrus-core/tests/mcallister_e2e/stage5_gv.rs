...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            ...
            "The corrected-volume residual now points at stale chamber data during the GV-corrected KKLT fixed-point iteration: production still selects small curves/GVs once in the input chamber, while the solved corrected Kähler point lies in a different FRST chamber and the final-chamber GV target-correction vector differs by relative_l2_delta=0.5969594710109491",
