...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_gv_context now distinguishes disabled residual q_N-domain comparisons from requested path-history probes that stop at an element limit; a target-7 schema-4 smoke report records unavailable_exceeded_element_limit_10000 instead of collapsing the rational-cone skip into not_run",
