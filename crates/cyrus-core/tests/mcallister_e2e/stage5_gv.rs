...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_first_principles now reports the local formula-sum GV values as a corrected-chamber diagnostic only: for 4-214-647 they cover 9/9 toric-missing classes with 9 nonzero values, give volume correction -0.2590023228059164, shift the toric-covered corrected-chamber volume correction by only +0.0005719649570432028, and still miss corrected_target_volumes.dat's implied GV vector with max_abs=0.09773695104401635 and relative_l2=1.2387268027775085 without promotion",
