...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            "The explicit general primal GV fallback currently reaches full 214-dimensional Mori-cone dualization; bounded DDM diagnostics stop loudly at configured limits, e.g. hyperplane 350/561658 with --primal-gv-max-deg 1",
