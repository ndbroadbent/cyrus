...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            ...
            "The leading checkpoint-t corrected-chamber GV target offenders are not explained by pair-vs-three-term pruning, by a uniform ±1 ambient gamma index shift, or by a mismatch between corrected_heights.dat and the checkpoint-t-induced chamber; next diagnostics should compare the McAllister/CYTools small-curve construction and per-curve sign conventions against a direct CYTools/Python trace",
