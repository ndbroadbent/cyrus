...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_first_principles now exports secondary_cone_heights_for_missing in corrected-chamber GV contexts, and mcallister_gv_context validates that the height vector is finite and matches the no-origin q-matrix width, setting up direct comparison between local wall circuits and the actual corrected global chamber height vector",
