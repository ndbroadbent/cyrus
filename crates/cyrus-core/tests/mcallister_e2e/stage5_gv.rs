...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "McAllister 4-214-647 rank-two CKYZ potent-ray GV checks now cover the first three entries for all 395 CKYZ rows and all ten entries for the canonical F0 source directions [1,1]/[1,2] and F1 source directions [2,1]/[3,1] without using potent_rays_gv.dat as input",
