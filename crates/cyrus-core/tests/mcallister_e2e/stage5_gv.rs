...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_gv_context now recomputes target_plus_star two-column omissions from the remaining point coordinates; for targets 7/8 exactly four omitted pairs each become compact CY3-shaped one-parameter sub-supports, but these remain diagnostic because deleting two points changes the original degree-6 two-parameter chamber row",
