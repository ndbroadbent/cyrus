...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_gv_context now exports predecessor candidates induced by bounded lower-seed decompositions; a target-7 schema-4 smoke report materializes the A+B+B subset splits as degree pairs 8+2, 2+8, 4+6, and 6+4 with toric/source-known status preserved for each side",
