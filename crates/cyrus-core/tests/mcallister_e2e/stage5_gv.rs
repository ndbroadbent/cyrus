...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            ...
            "Corrected-chamber ray plus LP-witness diagnostics cover 10/10 toric-missing curves with diagnostic volume correction -0.2597648038721059, but the LP-witness values are not certified supporting-face computations and remain non-production diagnostics",
