...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            ...
            "The corrected-volume residual now points at stale chamber data during the GV-corrected KKLT fixed-point iteration: production still selects small curves/GVs once in the input chamber, while the solved corrected Kähler point lies in a different FRST chamber",
