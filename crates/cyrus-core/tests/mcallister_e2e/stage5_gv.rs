...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        remaining_gaps: vec![
            ...
            "The leading checkpoint-t corrected-chamber GV target offenders are not explained by pair-vs-three-term pruning or by a uniform ±1 ambient gamma index shift; next diagnostics should compare the exact corrected_heights.dat chamber, the McAllister/CYTools small-curve construction, and per-curve sign conventions against a direct CYTools/Python trace",
