...
fn stage5_gv_computation_roadmap() {
    ...
    let roadmap = GvComputationRoadmap {
        ...
        verified_components: vec![
            ...
            "mcallister_first_principles reports validation-only corrected_target_volumes.dat deltas; for 4-214-647 the computed GV-corrected KKLT target vector differs by relative_l2=0.022036578712025 and max_abs=0.09773695104398727",
        ...
        remaining_gaps: vec![
            ...
            "The Kähler-vector residual is now traceable further upstream to corrected target τ construction: corrected_target_volumes.dat differs from Cyrus' computed GV-corrected KKLT target vector by relative_l2=0.022036578712025 and max_abs=0.09773695104398727, so divisor χ, GV target correction, and target-volume frame/convention remain the next items to audit",
